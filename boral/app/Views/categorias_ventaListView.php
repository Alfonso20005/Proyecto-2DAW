...
<title>Boral | Categorias Venta</title>
<div class="row">
    <div class="col-12">

        <!-- Titulo con estilo de Bootstrap -->
        <p class="display-4 text-center text-primary font-weight-bold">CATEGORIAS DE VENTA</p>

        <a href="<?php echo baseUrl();?>/categorias_venta/nuevo" class="btn btn-success mb-3">
                    <i class="fa-solid fa-plus"></i> Nueva Categoria Venta
            </a>
         ...
         if(count($categorias)>0){
             foreach($categorias as $r){
                 ?>
                    ...
                    <td><a href="<?php echo baseUrl();?>/categorias_venta/editar?id=<?php echo $r["id"];?>" class="btn btn-primary">
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    data:{id:id},
                    method:"POST",
                    url: "<?php echo baseUrl();?>/categorias_venta/eliminar", 
